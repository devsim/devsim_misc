...
if __name__ == "__main__":
  ...
  parser = argparse.ArgumentParser(description='Convert between Gmsh and Tetgen format')
  parser.add_argument('--gmsh',           help='the gmsh file for input/output', required=True)
  parser.add_argument('--tetgen',         help='the basename for tetgen input/output', default=True)
  parser.add_argument('--groups',         help='file to input/output the physical names in gmsh format', required=False)
  parser.add_argument('--gmsh_to_tetgen', help="convert gmsh to tetgen", default=False, action='store_true')
  parser.add_argument('--tetgen_to_gmsh', help="convert tetgen to gmsh", default=False, action='store_true')
