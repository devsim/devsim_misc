...
def delete_regions(regions_to_delete, pname_map, coordinates, triangles, tetrahedra):
    ...
    (new_coordinates, new_triangles, new_tetrahedra) = delete_coordinates(
        coordinates, triangles, new_tetrahedra)
...
def run(args):
    ...
    interface_map = get_interface_map(
        interfaces, pname_map, elem_ids, name_priority, interface_names)
...
#  print(triangles[0])
    ...
    (coordinates, triangles, tetrahedra) = delete_regions(
        regions_to_delete, pname_map, coordinates, triangles, tetrahedra)
